...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const mainContent = document.querySelectorAll('.main-content, .profile-body, [id*="main"], [class*="main"]');
    
    if (!userId) {
        // Hide main content, show auth
...
async function updateAvailableSlots() {
    ...
    try {
        ...
        const response = await fetch(`https://healthhub-production-90ef.up.railway.app/patient/booked-slots/${selectedDoctor.id}/${selectedDate}`);
